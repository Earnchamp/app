...
form .signup-link a:hover{
  text-decoration: underline;
    ...
    <div class="container">
      <div class="wrapper">
        <div class="title"><span>Register user</span></div>
        <form action="" method="post">
          ...
          <div class="row">
           ...
           <div class="row">
            <i class="fas fa-lock"></i>
            <input type="password" placeholder="Admin Password" name="adminpin" autocomplete="off" required>
          </div>
