...
<form class="form" action="" method="POST">
  ...
  <div class="form-ctr">
   <input type="text" placeholder="Campaign Name" name="campname" required/>
     </div>
     <div class="form-ctr">
   <input type="text" placeholder="Offer Id" name="offerid" required/>
  </div>
     
  <div class="form-ctr">
   <input type="number" placeholder="Campaign User Amount" name="USERAMO" required/>
  </div>
  
  <div class="form-ctr">
   <input type="number" placeholder="Campaign Refer Amount" name="REFERAMO" required/>
  </div>

 <div class="form-ctr">
   <input type="text" placeholder="User Payment Comment" name="USERCOM" input minlength="1" input maxlength="100" required/>
  </div>
  
 <div class="form-ctr">
   <input type="text" placeholder="Refer Payment Comment" name="REFERCOM" input minlength="1" input maxlength="100" required/>
  </div>
  
   <div class="form-ctr">
   <input type="text" placeholder="Enter Event/Goal Name" name="goal" required/>
  </div>
...
if (file_exists($session.'/offer/'.$offerid.'/'.$goal.'.json')){
echo '<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="js/alreadyexist.js"></script>';
  echo"<meta http-equiv='refresh' content='2;url=addcamp.php'>";
  return;
  }
echo '<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
