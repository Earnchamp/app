...
echo '<br><center><div class="gform"><div class="blue">|</div><div class="head">
Add Gateway </div>
<hr>
...
<form class="form" action="" method="POST">
  ...
  <div class="form-ctr">
   <input type="text" placeholder="Enter Peyment Url" name="url" required/>
     </div>
  
<input type="submit" name="submit" value="Update" required/><br><br>

<u>Gateway Parameters</u><br><br>
Paytm Number = {paytm}<br>
Amount = {amount}<br>
Comment = {comment}<br>
...
$json1='{"11":"'.$mid.'"}';
file_put_contents(''.$session.'/payment/index1.json', $json1);
