...
<form class="form" action="" method="POST">
 <div class="form-ctr">
   <input type="tel" placeholder="Enter User Number" name="num" input minlength="10" input maxlength="10" required/><input type="submit" name="submit" value="Ban" required/></center></form></div>';
}
if(isset($_POST['submit'])){
...
echo '<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="js/alreadybanned.js"></script>';
return;
  }
